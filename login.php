        ...
        <section class="container forms">
            <div class="form login">
                <div class="form-content">
                    <header><img src="img/logo-11.png" alt="" style="width:60px;"><br> Admin | Login</header>
                    <div class="form-link">
                        <span><b>NEW USER?</b> <a href="#" class="link signup-link">Click here to Register Here</a></span>
                    </div>
                    <form action="adminFunction.php" method="POST">
                        ...
                        <div class="form-link">
                            ...
                            <div class="form-link">
                                <a href="#" class="link forgot-pass-link">Forgot password?</a>
                            </div>
                        ...
                        <?php 
                            ...
                            if(isset($_SESSION['msg6'])){
                                echo '<div>' . $_SESSION['msg6'] . '</div>';
                                unset($_SESSION['msg6']);
                            }

                            if(isset($_SESSION['msg7'])){
                                echo '<div>' . $_SESSION['msg7'] . '</div>';
                                unset($_SESSION['msg7']);
                            }
                        ?>
                        </div>
            ...
            <div class="form signup">
                <div class="form-content">
                    <header><img src="img/logo-11.png" alt="" style="width:60px;"><br>Admin | Register</header>
                    <form action="adminFunction.php" method="POST">
                        <div class="field1 input-field">
                            <input type="text" placeholder="Garage Name" name="gname" class="input" required>
                        </div>

                        <div class="field1 input-field">
                            <input type="number" placeholder="Mobile No." name="mobile" class="number" required>
                        </div>
                        ...
                        <div class="field1 input-field">
                            <input type="address" placeholder="Address" name="address" class="address" required>
                        </div>
                        ...
                        <div class="field1 button-field">
                            <button type="submit" name="btn-sub2">Register</button>
                        </div>
