        ...
        <div class="row">
            ...
            <form action="adminFunction.php" method="post" enctype="multipart/form-data">
                <div class="card card-primary">
                    ...
                    <?php
                    $id = $_GET['id'];
                    $sql = "SELECT * FROM g_booking WHERE id='$id'";
                        ...
                        while ($row = mysqli_fetch_assoc($res)) { ?>
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="inputClientCompany" class="form-control" name="c_gst" value="<?php echo $row['c_gst']; ?>">
                                    </div>
                                    <div class="form-group">
                ...
                <div class="card card-danger">
                    ...
                    <div class="form-group">
                            ...
                            <select id="inputStatus" name="carbrand" class="form-control custom-select" disabled>
                                ...
                                <option value="<?php echo $rows['makeId']; ?>" <?php echo ($rows['makeId'] == $row['car_brand']) ? 'selected' : ''  ?> ><?php echo $rows['makeTitle']; ?></option>
                    ...
                    <div id="form_div">
                        <div class="table-responsive">
                            <table class="table" id="dynamicTable">
                                <thead>
                                    <tr> 
                                        <th>Service/Part Name:<span class="required-text">*</span></th>
                                ...
                                <!-- <div id="output"></div> -->
                                    ...
                                    <td><input type="number" name="total[]" id="total1" class="form-control-sm order_item_price"></td>
...
<script type="text/javascript">
    ...
    $("#add").click(function(){
        ...
        html_code += '<td><input type="number" name="total[]" id="total'+i+'" class="form-control-sm order_item_price"></td>';
